...
class Proveedor extends Model
{
    ...
    protected $attributes = [
        ...
        'imagen' => null, 'extension' => null, 'fechaalta' => null, 'fechabaja' => null, 'contacto' => null,
        'cantidadsolicitudcomprarealizada' => 0, 'cantidadsolicitudcompracancelada' => 0,
        'cantidadordencomprarealizada' => 0, 'cantidadordencompracancelada' => 0, 'cantidadcomprarealizada' => 0, 'cantidadcompracancelada' => 0,
        'cantidaddevolucioncomprarealizada' => 0, 'cantidaddevolucioncompracancelada' => 0, 'cantidadproductosolicitudcomprarealizada' => 0,
        'cantidadproductosolicitudcompracancelada' => 0, 'cantidadproductoordencomprarealizada' => 0, 'cantidadproductoordencompracancelada' => 0,
        'cantidadproductocomprarealizada' => 0, 'cantidadproductocompracancelada' => 0, 'cantidadproductodevolucioncomprarealizada' => 0, 'cantidadproductodevolucioncompracancelada' => 0,
        'cantidadtotalsolicitudcomprarealizada' => 0, 'cantidadtotalproductosolicitudcomprarealizada' => 0, 'cantidadtotalordencomprarealizada' => 0,
        'cantidadtotalproductoordencomprarealizada' => 0, 'cantidadtotalcomprarealizada' => 0, 'cantidadtotalproductocomprarealizada' => 0,
        'cantidadtotaldevolucioncomprarealizada' => 0, 'cantidadtotalproductodevolucioncomprarealizada' => 0,
    ];
    ...
    protected $fillable = [
        ...
        'cantidadsolicitudcomprarealizada', 'cantidadsolicitudcompracancelada', 'cantidadordencomprarealizada', 'cantidadordencompracancelada',
        'cantidadcomprarealizada', 'cantidadcompracancelada', 'cantidaddevolucioncomprarealizada', 'cantidaddevolucioncompracancelada',
        'cantidadproductosolicitudcomprarealizada', 'cantidadproductosolicitudcompracancelada', 'cantidadproductoordencomprarealizada', 'cantidadproductoordencompracancelada',
        'cantidadproductocomprarealizada', 'cantidadproductocompracancelada', 'cantidadproductodevolucioncomprarealizada', 'cantidadproductodevolucioncompracancelada',
        'cantidadtotalsolicitudcomprarealizada', 'cantidadtotalproductosolicitudcomprarealizada', 'cantidadtotalordencomprarealizada',
        'cantidadtotalproductoordencomprarealizada', 'cantidadtotalcomprarealizada', 'cantidadtotalproductocomprarealizada',
        'cantidadtotaldevolucioncomprarealizada', 'cantidadtotalproductodevolucioncomprarealizada',
