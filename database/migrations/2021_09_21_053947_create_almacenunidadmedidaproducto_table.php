...
class CreateAlmacenunidadmedidaproductoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('almacenunidadmedidaproducto', function (Blueprint $table) {
            $table->increments('idalmacenunidadmedidaproducto');
    ...
    {
        Schema::dropIfExists('almacenunidadmedidaproducto');
    }
}
