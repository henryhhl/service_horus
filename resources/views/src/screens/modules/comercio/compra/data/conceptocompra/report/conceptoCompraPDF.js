...
function ConceptoCompraPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE CONCEPTO COMPRA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { conceptoCompra.arrayConceptoCompra.map( ( item, key ) => {
                        return (
...
ConceptoCompraPDF.propTypes = {
    conceptoCompra: PropTypes.object,

    visible: PropTypes.bool,
};

ConceptoCompraPDF.defaultProps = {
    visible: false,
};

export default ConceptoCompraPDF;
