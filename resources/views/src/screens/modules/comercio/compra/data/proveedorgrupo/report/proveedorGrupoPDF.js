...
function ProveedorGrupoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE GRUPO PROVEEDOR" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { proveedorGrupo.arrayProveedorGrupo.map( ( item, key ) => {
                        return (
...
ProveedorGrupoPDF.propTypes = {
    proveedorGrupo: PropTypes.object,

    visible: PropTypes.bool,
};

ProveedorGrupoPDF.defaultProps = {
    visible: false,
};

export default ProveedorGrupoPDF;
