...
function ProveedorCargoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE CARGO PROVEEDOR" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { proveedorCargo.arrayProveedorCargo.map( ( item, key ) => {
                        return (
...
ProveedorCargoPDF.propTypes = {
    proveedorCargo: PropTypes.object,

    visible: PropTypes.bool,
};

ProveedorCargoPDF.defaultProps = {
    visible: false,
};

export default ProveedorCargoPDF;
