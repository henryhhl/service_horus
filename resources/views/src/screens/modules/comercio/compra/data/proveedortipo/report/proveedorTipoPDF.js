...
function ProveedorTipoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE TIPO PROVEEDOR" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { proveedorTipo.arrayProveedorTipo.map( ( item, key ) => {
                        return (
...
ProveedorTipoPDF.propTypes = {
    proveedorTipo: PropTypes.object,

    visible: PropTypes.bool,
};

ProveedorTipoPDF.defaultProps = {
    visible: false,
};

export default ProveedorTipoPDF;
