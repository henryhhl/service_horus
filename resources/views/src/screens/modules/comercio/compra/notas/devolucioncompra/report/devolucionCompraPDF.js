...
const styles = StyleSheet.create( {
    ...
    thead: {
        fontSize: 9, fontFamily: 'Oswald,Roboto,sans-serif', paddingLeft: 15,
    },
    tbody: {
        fontSize: 8, color: 'grey', paddingLeft: 8,
    },
    borderBottomColor: {
...
function DevolucionCompraPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE DEVOLUCIÓN COMPRA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10, }}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={{ paddingBottom: 2, paddingLeft: 5, }}> 
                                { devolucionCompra.fecha } 
                            </Text>
                            <Text style={{ paddingBottom: 3, paddingLeft: 10, }}> 
                                { devolucionCompra.hora } 
                            </Text>
                            {/* <Text style={{ paddingBottom: 2, }}> 
                                Pag: 
                            </Text> */}
                    ...
                    { devolucionCompra.arrayDevolucionCompra.map( ( item, key ) => {
                        return (
...
DevolucionCompraPDF.propTypes = {
    devolucionCompra: PropTypes.object,

    visible: PropTypes.bool,
};

DevolucionCompraPDF.defaultProps = {
    visible: false,
};

export default DevolucionCompraPDF;
