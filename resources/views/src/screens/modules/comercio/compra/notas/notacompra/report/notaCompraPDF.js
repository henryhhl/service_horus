...
function NotaCompraPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE NOTA COMPRA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { notaCompra.arrayNotaCompra.map( ( item, key ) => {
                        return (
...
NotaCompraPDF.propTypes = {
    notaCompra: PropTypes.object,

    visible: PropTypes.bool,
};

NotaCompraPDF.defaultProps = {
    visible: false,
};

export default NotaCompraPDF;
