...
function SolicitudCompraPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE SOLICITUD COMPRA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10, }}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={{ paddingBottom: 2, paddingLeft: 5, }}> 
                                { solicitudCompra.fecha } 
                            </Text>
                            <Text style={{ paddingBottom: 3, paddingLeft: 10, }}> 
                                { solicitudCompra.hora } 
                            </Text>
                            {/* <Text style={{ paddingBottom: 2, }}> 
                                Pag: 
                            </Text> */}
                    ...
                    { solicitudCompra.arraySolicitudCompra.map( ( item, key ) => {
                        return (
...
SolicitudCompraPDF.propTypes = {
    solicitudCompra: PropTypes.object,

    visible: PropTypes.bool,
};

SolicitudCompraPDF.defaultProps = {
    visible: false,
};

export default SolicitudCompraPDF;
