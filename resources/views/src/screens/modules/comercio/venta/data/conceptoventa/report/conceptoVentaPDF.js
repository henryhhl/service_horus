...
function ConceptoVentaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE CONCEPTO VENTA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { conceptoVenta.arrayConceptoVenta.map( ( item, key ) => {
                        return (
...
ConceptoVentaPDF.propTypes = {
    conceptoVenta: PropTypes.object,

    visible: PropTypes.bool,
};

ConceptoVentaPDF.defaultProps = {
    visible: false,
};

export default ConceptoVentaPDF;
