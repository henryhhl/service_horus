...
function ActividadEconomicaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE ACTIVIDAD ECONÓMICA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10, }}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={{ paddingBottom: 2, paddingLeft: 5, }}>
                                { actividadEconomica.fecha }
                            </Text>
                            <Text style={{ paddingBottom: 3, paddingLeft: 10, }}>
                                { actividadEconomica.hora }
                            </Text>
                            {/* <Text style={{ paddingBottom: 2, }}>
                                Pag:
                            </Text> */}
                    ...
                    { actividadEconomica.arrayActividadEconomica.map( ( item, key ) => {
                        return (
...
ActividadEconomicaPDF.propTypes = {
    actividadEconomica: PropTypes.object,

    visible: PropTypes.bool,
};

ActividadEconomicaPDF.defaultProps = {
    visible: false,
};

export default ActividadEconomicaPDF;
