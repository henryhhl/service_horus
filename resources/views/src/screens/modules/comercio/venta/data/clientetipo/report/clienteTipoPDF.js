...
function ClienteTipoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE TIPO CLIENTE" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { clienteTipo.arrayClienteTipo.map( ( item, key ) => {
                        return (
...
ClienteTipoPDF.propTypes = {
    clienteTipo: PropTypes.object,

    visible: PropTypes.bool,
};

ClienteTipoPDF.defaultProps = {
    visible: false,
};

export default ClienteTipoPDF;
