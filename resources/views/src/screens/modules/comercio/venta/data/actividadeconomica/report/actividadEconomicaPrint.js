...
class ActividadEconomicaPrint extends Component {
    constructor( props ) {
        super( props );
        this.state = {};
    };
    render() {
        const { actividadEconomica } = this.props;
        return (
            <>
                <ReactToPrint
                    trigger={ () => <a style={{ display: 'none', }} id="actividadeconomica_print">Generar</a>}
                    content={ () => this.componentActividadEconomicaRef }
                >
                </ReactToPrint>
                <div style={{ display: 'none' }}>
                    <ActividadEconomicaComponent
                        actividadEconomica={actividadEconomica}
                        ref={ el => (this.componentActividadEconomicaRef = el) }
                    />
                </div>
            </>
        );
...
class ActividadEconomicaComponent extends Component {
                            ...
                            <th colSpan='2' style={{ fontSize: 10, paddingTop: 5, color: 'grey', }}>
                                <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', }}>
                                    ...
                                    <div style={{ paddingRight: 40, display: 'block' }}>
                                        <div> { actividadEconomica.fecha }</div>
                                        <div style={{ paddingLeft: 5, }}> { actividadEconomica.hora }</div>
                                        {/* <div>Pag: 001</div> */}
                                    </div>
                                </div>
                            </th>
...
ActividadEconomicaPrint.propTypes = {
    actividadEconomica: PropTypes.object,
};

ActividadEconomicaPrint.defaultProps = {
};

export default ActividadEconomicaPrint;
