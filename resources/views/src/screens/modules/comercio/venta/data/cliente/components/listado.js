...
function C_ListadoCliente( props ) {
    ...
    function get_data( search = "" ) {
        httpRequest( 'get', webservices.wscomercioventacliente_index, {
                        ...
                        <table className="align-middle text-truncate mb-0 table table-bordered table-striped table-hover table-fixed">
                            ...
                            <tbody>
                                { array_data.map( ( item, key ) => {
                                    let style = (item.checked || value == item.idcliente) ? {background: '#e0f3ff'} : {};
                                    return (
...
C_ListadoCliente.defaultProps = {
    value: null,
    create: false,
}

export default C_ListadoCliente;
