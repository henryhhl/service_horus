...
function ListaPrecioPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE LISTA PRECIO" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { listaPrecio.arrayListaPrecio.map( ( item, key ) => {
                        return (
...
ListaPrecioPDF.propTypes = {
    listaPrecio: PropTypes.object,

    visible: PropTypes.bool,
};

ListaPrecioPDF.defaultProps = {
    visible: false,
};

export default ListaPrecioPDF;
