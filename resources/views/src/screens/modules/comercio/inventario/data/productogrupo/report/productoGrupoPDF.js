...
function ProductoGrupoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE GRUPO DE PRODUCTO" onRender={ ( ) => {
                setLoading( true );
            } }>
                { loading && <Page size="A4" style={ styles.page }>
                    ...
                    { productoGrupo.arrayProductoGrupo.map( ( item, key ) => {
                        return (
...
ProductoGrupoPDF.propTypes = {
    productoGrupo: PropTypes.object,

    visible: PropTypes.bool,
};

ProductoGrupoPDF.defaultProps = {
    visible: false,
};

export default ProductoGrupoPDF;
