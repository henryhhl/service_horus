...
function UnidadMedidaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE UNIDAD MEDIDA" onRender={ ( ) => {
                setLoading( true );
            } }>
                { loading && <Page size="A4" style={ styles.page }>
                    ...
                    { unidadMedida.arrayUnidadMedida.map( ( item, key ) => {
                        return (
...
UnidadMedidaPDF.propTypes = {
    unidadMedida: PropTypes.object,

    visible: PropTypes.bool,
};

UnidadMedidaPDF.defaultProps = {
    visible: false,
};
