...
function ProductoMarcaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE MARCA" onRender={ ( ) => {
                setLoading( true );
            } }>
                { loading && <Page size="A4" style={ styles.page }>
                    ...
                    { productoMarca.arrayProductoMarca.map( ( item, key ) => {
                        return (
...
ProductoMarcaPDF.propTypes = {
    productoMarca: PropTypes.object,

    visible: PropTypes.bool,
};

ProductoMarcaPDF.defaultProps = {
    visible: false,
};

export default ProductoMarcaPDF;
