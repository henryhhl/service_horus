...
function CategoriaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE CATEGORÍA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { categoria.arrayCategoria.map( ( item, key ) => {
                        return (
...
CategoriaPDF.propTypes = {
    categoria: PropTypes.object,

    visible: PropTypes.bool,
};

CategoriaPDF.defaultProps = {
    visible: false,
};
