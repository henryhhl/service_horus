...
function ArchivoCiudadClasificacion( props ) {
    const { archivo } = props;
...
ArchivoCiudadClasificacion.propTypes = {
...
ArchivoCiudadClasificacion.defaultProps = {
    
};

export default ArchivoCiudadClasificacion;
