...
function AlmacenPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE ALMACEN" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { almacen.arrayAlmacen.map( ( item, key ) => {
                        return (
...
AlmacenPDF.propTypes = {
    almacen: PropTypes.object,

    visible: PropTypes.bool,
};

AlmacenPDF.defaultProps = {
    visible: false,
};

export default AlmacenPDF;
