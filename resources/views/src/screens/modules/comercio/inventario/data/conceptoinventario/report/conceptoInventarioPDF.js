...
function ConceptoInventarioPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE CONCEPTO INVENTARIO" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10, }}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={{ paddingBottom: 2, paddingLeft: 5, }}> 
                                { conceptoInventario.fecha } 
                            </Text>
                            <Text style={{ paddingBottom: 3, paddingLeft: 10, }}> 
                                { conceptoInventario.hora } 
                            </Text>
                            {/* <Text style={{ paddingBottom: 2, }}> 
                                Pag: 
                            </Text> */}
                    ...
                    { conceptoInventario.arrayConceptoInventario.map( ( item, key ) => {
                        return (
...
ConceptoInventarioPDF.propTypes = {
    conceptoInventario: PropTypes.object,

    visible: PropTypes.bool,
};

ConceptoInventarioPDF.defaultProps = {
    visible: false,
};

export default ConceptoInventarioPDF;
