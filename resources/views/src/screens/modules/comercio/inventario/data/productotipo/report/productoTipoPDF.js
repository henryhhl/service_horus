...
function ProductoTipoPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE TIPO PRODUCTO" onRender={ ( ) => {
                setLoading( true );
            } }>
                { loading && <Page size="A4" style={ styles.page }>
                    ...
                    { productoTipo.arrayProductoTipo.map( ( item, key ) => {
                        return (
...
ProductoTipoPDF.propTypes = {
    productoTipo: PropTypes.object,

    visible: PropTypes.bool,
};

ProductoTipoPDF.defaultProps = {
    visible: false,
};

export default ProductoTipoPDF;
