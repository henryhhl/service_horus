...
function ArchivoConceptoInventario( props ) {
    const { archivo } = props;
...
ArchivoConceptoInventario.propTypes = {
...
ArchivoConceptoInventario.defaultProps = {
    
};

export default ArchivoConceptoInventario;
