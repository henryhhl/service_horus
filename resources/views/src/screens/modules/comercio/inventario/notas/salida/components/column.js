...
export const columns = ( notaSalida, disabled, onVisibleProducto = () => {}, onChangeDetalle = () => {} ) => {
    ...
    function updateTotales() {
        ...
        let pesototal = 0;
        let volumentotal = 0;
        notaSalida.arrayNotaSalidaDetalle.map( (item) => {
        ...
        notaSalida.cantidadtotal = parseInt(cantidadtotal);
        notaSalida.montototal = parseFloat(montototal).toFixed(2);
        notaSalida.nrocajastotal = parseFloat(nrocajastotal).toFixed(2);
        notaSalida.pesototal = parseFloat(pesototal).toFixed(2);
        notaSalida.volumentotal = parseFloat(volumentotal).toFixed(2);
    };

    function onAddRowDetalle() {
        const element = {
            key: notaSalida.arrayNotaSalidaDetalle.length,
            codigo: "",
            producto: "",
            fkidproducto: null,
            unidadmedida: "",
            ...
            sucursal: notaSalida.sucursal,

            fkidalmacen: notaSalida.fkidalmacen,
            almacen: notaSalida.almacen,
        ...
        notaSalida.arrayNotaSalidaDetalle = [ ...notaSalida.arrayNotaSalidaDetalle, element ];
        onChangeDetalle( notaSalida );
    };
