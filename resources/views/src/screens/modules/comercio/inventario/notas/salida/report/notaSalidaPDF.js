...
function NotaSalidaPDF( props ) {
    ...
    return (
        <PDFViewer style={ styles.init } >
            <Document title="REPORTE NOTA SALIDA" onRender={ ( ) => {
                setLoading( true );
            } }>
                <Page size="A4" style={ styles.page }>
                    ...
                    { notaSalida.arrayNotaSalida.map( ( item, key ) => {
                        return (
...
NotaSalidaPDF.propTypes = {
    notaSalida: PropTypes.object,

    visible: PropTypes.bool,
};

NotaSalidaPDF.defaultProps = {
    visible: false,
};

export default NotaSalidaPDF;
