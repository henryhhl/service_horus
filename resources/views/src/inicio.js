...
import { C_Loading, C_Message } from './components';
...
const Inicio = (props) => {
    ...
    const [arrayProveedor, setArrayProveedor] = useState([]);
    ...
    function get_data() {
        ...
        .then( (result) => {
            ...
            if (result.response == 1) {
                ...
                setArrayProducto(result.arrayProducto);
                setArrayCliente(result.arrayCliente);
            }
        } );
    }
        ...
        <>
            ...
            <div className="main-card mb-3 card p-0">
                {/* <div className="card-header pr-3 pl-3"> */}
                    ...
                    <div className="card-header-tab card-header pr-3 pl-3">
                        <div className="card-header-title font-size-lg text-capitalize">
                            <i className="header-icon lnr-dice mr-3 text-muted opacity-6"> </i>
                            HORUS S.R.L
                        </div>
                        <div className="btn-actions-pane-right actions-icon-btn">
                            <div className="btn-group dropdown">
                                <button type="button" className="btn-icon btn-icon-only btn btn-link">
                                    <i className="pe-7s-refresh-2 fa fa-refresh btn-icon-wrapper"
                                        onClick={onRefresh}
                                    ></i>
                                </button>
                            </div>
                ...
                <div className="card-body">
                    ...
                    <div className="row mb-2">
                        <div className="col-lg-4 col-md-4 col-sm-12 mb-1">
                            <div className='card-hover-shadow-2x card'>
                                                ...
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>NOTAS DE COMPRAS</font></font>
                                                        </div>
                                                        <div className="widget-subheading">
                                        ...
                                        <div className="widget-content p-0">
                                            <div className="widget-content-outer">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading"><font style={{ "verticalAlign": "inherit" }}>
                                                            <font style={{ "verticalAlign": "inherit" }}>NOTAS DE SALIDAS</font></font>
                                                        </div>
                                                        <div className="widget-subheading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>cantidad de notas de salidas realizados</font></font>
                                                        </div>
                                                    </div>
                                                    <div className="widget-content-right">
                                                        <div className="widget-numbers text-warning">
                                                            <font style={{ "verticalAlign": "inherit" }}>
                                                                <font style={{ "verticalAlign": "inherit" }}>
                                                                    { getCantidadRealizadaNotaTransaccion(1) - getCantidadCanceladaNotaTransaccion(1) }
                                                                </font>
                                                            </font>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="widget-content p-0">
                                            <div className="widget-content-outer">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>DEVOLUCIÓN DE COMPRA</font></font>
                                                        </div>
                                                        <div className="widget-subheading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>cantidad devoluciones de compras realizados</font></font>
                                                        </div>
                                                    </div>
                                                    <div className="widget-content-right">
                                                        <div className="widget-numbers text-danger">
                                                            <font style={{ "verticalAlign": "inherit" }}>
                                                                <font style={{ "verticalAlign": "inherit" }}>
                                                                    { getCantidadRealizadaNotaTransaccion(6) - getCantidadCanceladaNotaTransaccion(6) }
                                                                </font>
                                                            </font>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="widget-content p-0">
                                            <div className="widget-content-outer">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>DEVOLUCIÓN DE VENTA</font></font>
                                                        </div>
                                                        <div className="widget-subheading">
                                                            <font style={{ "verticalAlign": "inherit" }}><font style={{ "verticalAlign": "inherit" }}>cantidad de devoluciones de ventas realizadas</font></font>
                                                        </div>
                                                    </div>
                                                    <div className="widget-content-right">
                                                        <div className="widget-numbers text-danger">
                                                            <font style={{ "verticalAlign": "inherit" }}>
                                                                <font style={{ "verticalAlign": "inherit" }}>
                                                                    { getCantidadRealizadaNotaTransaccion(8) - getCantidadCanceladaNotaTransaccion(8) }
                                                                </font>
                                                            </font>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="scrollbar-container ps ps--active-y">
                                        <div className="p-2">
                                            <ul className="todo-list-wrapper list-group list-group-flush">
                                                { arrayProducto.map( (item, key) => {
                                                    return (
                                                        <li className="list-group-item" key={key}>
                                                            <div className="todo-indicator bg-primary"></div>
                                                            <div className="widget-content p-0 pl-2">
                                                                <div className="widget-content-wrapper">
                                                                    <div className="widget-content-left">
                                                                        <div className="widget-heading">
                                                                            { item.codigo }
                                                            ...
                                                            <div className="widget-content-left mr-2">
                                                                <div className="custom-checkbox custom-control">
                                                                    <input type="checkbox" id="exampleCustomCheckbox2" className="custom-control-input" />
                                                                        <label className="custom-control-label" htmlFor="exampleCustomCheckbox2">&nbsp;</label>
                                                                </div>
                                                            </div>
